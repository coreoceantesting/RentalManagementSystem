<x-admin.layout>
    ...
    <x-slot name="heading">Scheme</x-slot>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select class="form-control" name="architect" id="architect">
                                        ...
                                        @foreach ($architects as $architect)
                                            <option value="{{ $architect->id }}">{{ $architect->architect_name }}</option>
                                        @endforeach                                
                                    </select>
                                    <span class="text-danger is-invalid architect_err"></span>
                                </div>
                            </div>
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id="buttons-datatables" class="table table-bordered nowrap align-middle" style="width:100%">
                                ...
                                <tbody>
                                    @foreach ($shemes as $index => $sheme)
                                        <tr>
                                            <td>{{ $index + 1 }}</td>
                                            <td>{{ $sheme->scheme_name }}</td>
                                            <td>{{ $sheme->architect_name }}</td>
                                            <td>{{ $sheme->contractor_name }}</td>
                                            <td>
                                                <button class="edit-element btn text-secondary px-2 py-1" title="Edit Contractor" data-id="{{ $sheme->id }}"><i data-feather="edit"></i></button>
                                                <button class="btn text-danger rem-element px-2 py-1" title="Delete Contractor" data-id="{{ $sheme->id }}"><i data-feather="trash-2"></i> </button>
                                            </td>
                                        </tr>
                                    @endforeach
                            </table>
