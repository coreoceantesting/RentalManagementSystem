...
<head>
    ...
    <meta charset="utf-8" />
    <title>Rental Management System | Sign In</title>
                                            ...
                                            <form id="loginForm">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <div class="position-relative auth-pass-inputgroup mb-3">
                                                        ...
                                                        <button class="btn btn-link position-absolute end-0 top-0 text-decoration-none text-muted password-addon" type="button" style="padding-right: 8%" id="password-addon"><i class="ri-eye-fill align-middle"></i></button>
