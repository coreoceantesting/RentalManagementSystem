<x-admin.layout>
    <x-slot name="title">View Detailas</x-slot>
    <x-slot name="heading">View Detailas</x-slot>
                        ...
                        <div class="card-body">
                            <div class="mb-3 row">
                                <div class="card-header">
                                    <h4 class="text-center"><b>View Details (तपशील पहा)</b></h4>
                                </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" id="name_of_scheme" name="name_of_scheme" type="text" placeholder="Enter Name Of Scheme" value="{{ $scheme_detail->name_of_scheme }}" readonly>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" id="location_of_scheme" name="location_of_scheme" type="text" placeholder="Enter Applicant Name" value="{{ $scheme_detail->location_of_scheme }}" readonly>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" id="land_details" name="land_details" type="text" placeholder="Enter Land Details" value="{{ $scheme_detail->land_details }}" readonly>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" id="developer_name" name="developer_name" type="text" placeholder="Enter Developer Name" value="{{ $scheme_detail->developer_name }}" readonly>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" id="architect_name" name="architect_name" type="text" placeholder="Enter Architect Name" value="{{ $scheme_detail->architect_name }}" readonly>
                                ...
                                <div class="col-md-5">
                                    ...
                                    <input class="form-control" id="name_of_slum_developer" name="name_of_slum_developer" type="text" placeholder="Enter Name Of Slum Developer" value="{{ $scheme_detail->name_of_slum_developer }}" readonly>
                                ...
                                <div class="col-md-4">
                                    ...
                                    {{-- <input class="form-control" id="numbering_annexure_two" name="numbering_annexure_two" type="file" placeholder="Enter Numbering Annexure 2" readonly> --}}
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" id="bank_name" name="bank_name" type="text" placeholder="Enter Bank Name" value="{{ $scheme_detail->bank_name }}" readonly>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" id="bank_account_no" name="bank_account_no" type="text" placeholder="Enter Bank Account Number" value="{{ $scheme_detail->bank_account_no }}" readonly>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" id="period_of_rent" name="period_of_rent" type="text" placeholder="Enter Period Of Rent" value="{{ $scheme_detail->period_of_rent }}" readonly>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" id="amount_to_pay" name="amount_to_pay" type="text" placeholder="Enter Amount To Pay" value="{{ $scheme_detail->amount_to_pay }}" readonly>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" id="paid_amount" name="paid_amount" type="text" placeholder="Enter Paid Amount" value="{{ $scheme_detail->paid_amount }}" readonly>
