                                ...
                                @foreach ($application_lists as $index => $list)
                                    <tr>
                                        ...
                                        @if (auth()->user()->roles->pluck('name')[0] == 'registrar')
                                            <td>{{ $list->stopwork_status_by_register }}</td>
                                            <td>{{ $list->stopwork_approval_remark_by_register }}</td>                                            
                                        @endif
                                        @if (auth()->user()->roles->pluck('name')[0] == 'secretary')
                                            <td>{{ $list->stopwork_status_by_secretory }}</td>
                                            <td>{{ $list->stopwork_approval_remark_by_secretory }}</td>                                            
                                        @endif
                                        @if (auth()->user()->roles->pluck('name')[0] == 'ceo')
                                            <td>{{ $list->stopwork_status_by_ceo }}</td>
                                            <td>{{ $list->stopwork_approval_remark_by_ceo }}</td>                                            
                                        @endif
                                        <td>
