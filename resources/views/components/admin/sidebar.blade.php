<div class="app-menu navbar-menu">
    ...
    <div class="navbar-brand-box">
        ...
        <a href="index.html" class="logo logo-dark">
            <span class="logo-sm">
                <img src="{{ asset('admin/images/sidebarlogo.png') }}" alt="" height="22" />
            </span>
            <span class="logo-lg">
                <img src="{{ asset('admin/images/sidebarlogo.png') }}" alt="" height="17" />
            </span>
        </a>
        <!-- Light Logo-->
        <a href="index.html" class="logo logo-light">
            <span class="logo-sm">
                <img src="{{ asset('admin/images/sidebarlogo2.png') }}" alt="" height="40" />
            </span>
            <span class="logo-lg">
                <img src="{{ asset('admin/images/sidebarlogo2.png') }}" alt="" height="40" />
            </span>
